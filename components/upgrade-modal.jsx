...
export default function UpgradeModal({ isOpen, onClose, trigger = "limit" }) {
  return (
    <Dialog open={isOpen} onOpenChange={onClose} >
      <DialogContent className="sm:max-w-2xl bg-black/90 backdrop-blur-lg border border-gray-800 mt-10">
        <DialogHeader>
        ...
        <div className="flex gap-3">
          <Button variant="secondary" onClick={onClose} className="flex-1 cursor-pointer">
            Maybe Later
          </Button>
        </div>
      </DialogContent>
