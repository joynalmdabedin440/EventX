...
Light refreshments will be provided. Limited seats available.`,
    ...
    city: "Dhaka",
    state: "Dhaka",
    venue: "https://maps.google.com/?q=Baridhara+Tech+Park+Dhaka",
    address: "Baridhara Tech Park, Dhaka",
    capacity: 50,
    ticketType: "free",
    coverImage:
...
Pizza and drinks provided!`,
    ...
    city: "Chittagong",
    state: "Chittagong",
    venue: "https://maps.google.com/?q=Chittagong+Tech+Hub",
    address: "Chittagong Tech Hub, Halishahar",
    capacity: 100,
    ticketType: "free",
    coverImage:
...
Food and beverages available for purchase at the venue.`,
    ...
    city: "Dhaka",
    state: "Dhaka",
    venue: "https://maps.google.com/?q=Gulshan+Music+Venue+Dhaka",
    address: "Gulshan Music Venue, Gulshan, Dhaka",
    capacity: 120,
    ticketType: "paid",
    ticketPrice: 499,
    coverImage:
...
Continental breakfast included in registration.`,
    ...
    city: "Dhaka",
    state: "Dhaka",
    venue: "https://maps.google.com/?q=Startup+Hub+Dhaka",
    address: "Startup Hub, Banani, Dhaka",
    capacity: 40,
    ticketType: "paid",
    ticketPrice: 299,
    coverImage:
...
Chai stops included along the way!`,
    ...
    city: "Dhaka",
    state: "Dhaka",
    venue: "https://maps.google.com/?q=Old+Dhaka+Street+Tour",
    address: "Old Dhaka Street, near Chawkbazar, Dhaka",
    capacity: 25,
    ticketType: "paid",
    ticketPrice: 799,
    coverImage:
...
Laptop required. Course materials provided.`,
    ...
    city: "Sylhet",
    state: "Sylhet",
    venue: "https://maps.google.com/?q=Sylhet+Tech+Hub",
    address: "Sylhet Tech Hub, Sylhet",
    capacity: 30,
    ticketType: "free",
    coverImage:
...
Energy drinks and snacks available. Exciting commentary and crowd interaction!`,
    ...
    city: "Narayanganj",
    state: "Dhaka",
    venue: "https://maps.google.com/?q=Gaming+Hub+Narayanganj",
    address: "Gaming Hub, City Center, Narayanganj",
    capacity: 80,
    ticketType: "paid",
    ticketPrice: 200,
    coverImage:
...
Open to all genders. Q&A session and networking lunch included.`,
    ...
    city: "Comilla",
    state: "Chittagong",
    venue: "https://maps.google.com/?q=Tech+Hub+Comilla",
    address: "Tech Hub, Comilla",
    capacity: 40,
    ticketType: "free",
    coverImage:
...
Itinerary:
- Day 1: Cox's Bazar to Beach Trail (9km trek)
...
Transport from Delhi available at additional cost.`,
    ...
    city: "Cox's Bazar",
    state: "Chittagong",
    venue: "https://maps.google.com/?q=Cox's+Bazar+Beach",
    address: "Cox's Bazar Beach, Cox's Bazar",
    capacity: 20,
    ticketType: "paid",
    ticketPrice: 2500,
    coverImage:
...
Refreshments provided. A great way to give back to nature while meeting like-minded people!`,
    ...
    city: "Barisal",
    state: "Barisal",
    venue: "https://maps.google.com/?q=Barisal+Beach+Yoga",
    address: "Sundarbans Yoga Retreat, Barisal",
    capacity: 100,
    ticketType: "free",
    coverImage:
...
Code examples and cheat sheets provided.`,
    ...
    city: "Jessore",
    state: "Khulna",
    venue: "https://maps.google.com/?q=Jessore+Startup+Hub",
    address: "CIIE, Jessore Campus",
    capacity: 40,
    ticketType: "paid",
    ticketPrice: 999,
    coverImage:
...
Sleeping bags welcome. Food and drinks provided throughout.`,
    ...
    city: "Mymensingh",
    state: "Mymensingh",
    venue: "https://maps.google.com/?q=Mymensingh+Cultural+Centre",
    address: "Mymensingh International Centre, Domlur",
    capacity: 60,
    ticketType: "paid",
    ticketPrice: 500,
    coverImage:
...
Lunch and refreshments included. Bring your laptop!`,
    ...
    city: "Dhaka",
    state: "Dhaka",
    venue: "https://maps.google.com/?q=Tech+Hub+Dhaka+Banani",
    address: "Tech Hub, Banani, Dhaka",
    capacity: 40,
    ticketType: "paid",
    ticketPrice: 1499,
    coverImage:
...
Continental breakfast and unlimited coffee included!`,
    ...
    city: "Narayanganj",
    state: "Dhaka",
    venue: "https://maps.google.com/?q=Innovation+Center+Narayanganj",
    address: "Innovation Center, Narayanganj",
    capacity: 35,
    ticketType: "paid",
    ticketPrice: 399,
    coverImage:
...
Snacks and beverages provided both days.`,
    ...
    city: "Chittagong",
    state: "Chittagong",
    venue: "https://maps.google.com/?q=Arts+Gallery+Chittagong",
    address: "Arts Gallery, Agrabad, Chittagong",
    capacity: 20,
    ticketType: "paid",
    ticketPrice: 2499,
    coverImage:
  ...
  },
  {
    ...
    description: `The biggest corporate cricket showdown in Dhaka is back!
...
Perfect for team building and corporate bonding!`,
    ...
    city: "Sylhet",
    state: "Sylhet",
    venue: "https://maps.google.com/?q=Sylhet+Sports+Stadium",
    address: "Sylhet Sports Stadium, Sylhet",
    capacity: 180,
    ticketType: "paid",
    ticketPrice: 500,
    coverImage:
...
Healthy snacks and herbal teas included.`,
    ...
    city: "Mymensingh",
    state: "Mymensingh",
    venue: "https://maps.google.com/?q=Wellness+Center+Mymensingh",
    address: "Wellness Center, South City, Mymensingh",
    capacity: 25,
    ticketType: "paid",
    ticketPrice: 899,
    coverImage:
